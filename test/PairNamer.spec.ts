...
describe('PairNamer', () => {
  ...
  describe('#pairName', () => {
    ...
    it('concatenation', async () => {
      expect(await pairName('DAI Stable Coin', 'MKR Token', 'Snackswap Liquidity Provider Share for ', '.')).to.eq(
        'Snackswap Liquidity Provider Share for DAI Stable Coin:MKR Token.'
      )
    })
  })
